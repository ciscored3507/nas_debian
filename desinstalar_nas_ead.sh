...
for grp in grp_empleados_ead grp_sistemas grp_c1_admin grp_c1_analista grp_c1_asesor grp_c2_admin grp_c2_analista grp_c2_asesor; do
...
echo " sudo bash /home/nas/ejecutar_configuracion_ead.sh"
echo "=============================================================================="
